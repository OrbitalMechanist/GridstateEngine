...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool StrEquals(const char* str1, const char* str2, uint32_t count)
{
    NS_ASSERT(str1 != nullptr);
    NS_ASSERT(str2 != nullptr);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool StrCaseEquals(const char* str1, const char* str2, uint32_t count)
{
    NS_ASSERT(str1 != nullptr);
    NS_ASSERT(str2 != nullptr);
    return StrCaseCompare(str1, str2, count) == 0;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline int StrCaseFindLast(const char* str, const char* value)
{
    NS_ASSERT(str != nullptr);
    NS_ASSERT(value != nullptr);
    ...
    for (int i = len - valueLen; i >= 0; i--)
    {
        if (StrCaseCompare(str + i, value, valueLen) == 0)
        {
            return i;
        }
    }
