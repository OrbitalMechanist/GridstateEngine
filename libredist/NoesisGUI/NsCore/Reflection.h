...
/// Iterates the registered types calling the passed in function, passing user data to it
typedef void (*EnumTypesUserCallback)(void* user, const Type* type);
NS_CORE_KERNEL_API void EnumTypes(void* user, EnumTypesUserCallback callback);
