...
////////////////////////////////////////////////////////////////////////////////////////////////////
#define NS_REGISTER_COMPONENT(T) \
    { \
        const Noesis::TypeClass* type = Noesis::TypeOf<T>(); \
...
////////////////////////////////////////////////////////////////////////////////////////////////////
#define NS_REGISTER_STRUCT(T) \
    { \
        const Noesis::TypeClass* type = Noesis::TypeOf<T>(); \
        Factory::RegisterComponent(type->GetTypeId(), Symbol::Null(), [](Symbol) -> BaseComponent* \
        { \
            return new Boxed<T>(); \
        }); \
    }
