...
bool StrEquals(const char* str1, const char* str2, uint32_t count);
bool StrCaseEquals(const char* str1, const char* str2);
bool StrCaseEquals(const char* str1, const char* str2, uint32_t count);
...
int StrCaseFindLast(const char* str, const char* value);
