...
public:
    ...
    /// This is a special constructor that will not add the string to the internal table
    ...
    /// Returns a symbol created from a static string (characters are not internally copied)
