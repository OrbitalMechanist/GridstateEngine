...
struct CornerRadius
{
    ...
    NS_IMPLEMENT_INLINE_REFLECTION(CornerRadius, NoParent)
    {
        NsProp("TopLeft", &CornerRadius::topLeft);
        NsProp("TopRight", &CornerRadius::topRight);
        NsProp("BottomRight", &CornerRadius::bottomRight);
        NsProp("BottomLeft", &CornerRadius::bottomLeft);
    }
};
